...
*Repositories are private; access on request.*
...
![Agentic SDLC Harness](https://img.shields.io/badge/ASF-Agentic_SDLC_Harness-D97757?style=flat-square&logo=anthropic)
...
![Brownfield AI Readiness](https://img.shields.io/badge/Brownfield-AI_Readiness_Scanner-3776AB?style=flat-square&logo=python)
...
![LLM Inference Economics](https://img.shields.io/badge/Build_vs_Buy-LLM_Inference_Economics-2E8B57?style=flat-square&logo=nvidia)
...
![LangGraph RAG](https://img.shields.io/badge/LangGraph-RAG_Assistant-412991?style=flat-square&logo=openai)
...
![HuggingFace Local LLM](https://img.shields.io/badge/HuggingFace-Local_LLM-FF6F00?style=flat-square&logo=huggingface)
...
![Event-Driven](https://img.shields.io/badge/RabbitMQ-Event_Driven-FF6600?style=flat-square&logo=rabbitmq)
...
![Databricks ETL](https://img.shields.io/badge/Databricks-ETL_Pipeline-FF3621?style=flat-square&logo=databricks)
...
![Docker Microservices](https://img.shields.io/badge/Docker-Microservices_Template-2496ED?style=flat-square&logo=docker)
...
![Kubernetes Patterns](https://img.shields.io/badge/Kubernetes-Deployment_Patterns-326CE5?style=flat-square&logo=kubernetes)
...
![Spring Boot](https://img.shields.io/badge/Spring_Boot-Microservices-6DB33F?style=flat-square&logo=springboot)
...
![Monitoring Stack](https://img.shields.io/badge/Prometheus-Observability_Stack-E6522C?style=flat-square&logo=prometheus)
...
![Terraform IaC](https://img.shields.io/badge/Terraform-IaC_Demos-7B42BC?style=flat-square&logo=terraform)
...
![AWS CDK](https://img.shields.io/badge/AWS_CDK-Cloud_Patterns-FF9900?style=flat-square&logo=amazonaws)
...
![CI/CD Pipelines](https://img.shields.io/badge/GitHub_Actions-CI/CD_Templates-2088FF?style=flat-square&logo=githubactions)
...
- **Self-hosting competes with the open model's own API, not a frontier API**
...
- **Prefer workload identity over any stored credential**
...
- **RAG maturity level: naive retrieval behind a deterministic state machine**
...
- **Alert on error-budget burn rate, not on static thresholds**
...
- **Borrow distributed-systems patterns for agentic systems, but not the retry semantics**
...
The remaining twenty-six live in each repository's **Design decisions**
section.
